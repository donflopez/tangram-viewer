  ...
  window.requestAnimFrame = function ()
{
  ...
  var canvas = this.$('#landing-canvas')[0];

  var context = canvas.getContext('2d');

  // var W = window.innerWidth, H = window.innerHeight;
  let computedStyles = window.getComputedStyle(canvas);

  canvas.width = parseInt(computedStyles.width);
  canvas.height = parseInt(computedStyles.height);
